...
namespace Naylah.Xamarin.Android.Renderers
{
    public class FloatLabeledEntryRenderer : global::Xamarin.Forms.Platform.Android.AppCompat.ViewRenderer<FloatLabeledEntry, TextInputLayout>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<FloatLabeledEntry> e)
        {
        ...
        private void SetHintText()
        {
            ...
            {
                NativeView.EditText.SetHintTextColor(StyleKit.Current.PrimaryTextColor.ToAndroid());
            }
            else
            {
        ...
        private void SetTextColor()
        {
            if (Element.Theme == BasicTheme.Dark)
            {
                NativeView.EditText.SetTextColor(StyleKit.Current.PrimaryTextColor.ToAndroid());
            }
            else
            {
        ...
        protected override TextInputLayout CreateNativeControl()
        {
            if (Element.Theme == BasicTheme.Dark)
            {
                if (IsNumeric)
                {
                    return (TextInputLayout)LayoutInflater.From(Context).Inflate(Naylah.Xamarin.Android.Resource.Layout.HandleCustomTextInputLayout, null);
                }
                else
                {
            ...
            else
            {
                if (IsNumeric)
                {
                    return (TextInputLayout)LayoutInflater.From(Context).Inflate(Naylah.Xamarin.Android.Resource.Layout.HandleCustomTextInputLayoutLight, null);
                }
                else
                {
                    return (TextInputLayout)LayoutInflater.From(Context).Inflate(Naylah.Xamarin.Android.Resource.Layout.TextInputLayoutLight, null);
                }
            }
        }
