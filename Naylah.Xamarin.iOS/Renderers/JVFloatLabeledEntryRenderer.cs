...
{
    public class JVFloatLabeledEntryRenderer : ViewRenderer<EntryBase, FloatLabeledTextField>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<EntryBase> e)
        {
            ...
            if (jfflEntry != null)
            {
                ...
                //var color = jfflEntry.Theme == EntryTheme.Dark ? Color.Black.ToUIColor() : Color.White.ToUIColor();

                var newView = new FloatLabeledTextField(
        ...
        {
            EntryBase arg_06_0 = base.Element;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (e.PropertyName == global::Xamarin.Forms.InputView.KeyboardProperty.PropertyName)
                            {
                                this.UpdateKeyboard();
                            }
                        }
        ...
        private void SetTheme()
        {
            ...
            Control.FloatingLabelTextColor = Control.TextColor;
            Control.FloatingLabelActiveTextColor = Control.TextColor;
